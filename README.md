...
Dans l'app, configure ensuite la `Cle cloud` (icone 🔑 en haut). C'est une valeur longue/aleatoire (secret partage)
qui controle l'acces cloud via l'en-tete `x-store-id` (RLS).
